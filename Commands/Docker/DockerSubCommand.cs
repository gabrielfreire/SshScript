...
{
    [Command(Name = "docker", Description = "Run docker commands in a remote machine via SSH")]
    public class DockerSubCommand : BaseCommand
    {
        ...
        [Option(CommandOptionType.SingleValue, ShortName = "c", LongName = "command", Description = "Docker Command", ValueName = "command", ShowInHelpText = true)]
